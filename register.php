				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" action="register.php" method="post">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input type="text" name="username" class="sizefull s-text7 p-l-22 p-r-22"  placeholder="Enter Username" required>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
							<input type="text" name="email" class="sizefull s-text7 p-l-22 p-r-22"  placeholder="Enter Email Address" required>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
							<input type="password" name="pass1" class="sizefull s-text7 p-l-22 p-r-22"  placeholder="Enter Password" required>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
							<input type="password" name="pass2" class="sizefull s-text7 p-l-22 p-r-22" placeholder="Confirm Password" required>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input type="text" name="city" class="sizefull s-text7 p-l-22 p-r-22" placeholder="Enter City/Town" required>
						</div>
						<textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="address" placeholder="Enter Address"></textarea>
						...
						<div class="w-size25">
							<!-- Button -->
							<input type="submit" name="Register" value="Register"  class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4"/>
						</div>
						<hr>
									...
									if( mysqli_num_rows($result) > 0)
										{
											...
											if($password1==$password2){
												...
												$insert = "insert into tblUser ( username, email, password, province, city, address) 
															values ('$username','$email','$password1','$province','$city','$address')";
