...
<body class="animsition" ng-controller="LoginCtrl">
	...
	<section class="bgwhite p-t-66 p-b-60">
		<div class="container">
			...
			if(isset($_POST['login'])){
				...
				$sel_c = "select * from tbluser where username='$username' AND password='$password'";
				...
				$ip=getIp();
				$sel_cart ="select * from tblcart where ip_add='$ip'";
...
<!--===============================================================================================-->
	...
	<script src="angularScripts/Login_script.js"></script>
<!--===============================================================================================-->
