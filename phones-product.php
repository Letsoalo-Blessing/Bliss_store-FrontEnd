			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					...
					if(isset($_SESSION['username'])){
						...
						<img src='images/icons/icon-header-01.png' class='header-icon1' alt='ICON' <p>"; $_SESSION['username']; echo"</p>
						
                    </a><span class='linedivide1'></span>
                    <a href='login.php' class='header-wrapicon1 dis-block'>Log out</a>";
			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
						<li class="p-t-4">
								<a href="accessories-product.php" class="s-text13">
									Accessories
								</a>
							</li>

							<li class="p-t-4">
								<a href="phones-product.php" class="s-text13">
									Phones & Tabloid
								</a>
							</li>

							<li class="p-t-4">
								<a href="tvGames-product.php" class="s-text13">
									Video Games and Tvs
								</a>
							</li>

							<li class="p-t-4">
								<a href="Laptops-product.php" class="s-text13">
									Laptops
								</a>
							</li>

							<li class="p-t-4">
								<a href="camera-product.php" class="s-text13">
									Cameras
								</a>
							</li>

							<li class="p-t-4">
								<a href="clothing-product.php" class="s-text13">
									Clothing
								</a>
							</li>
						</ul>
